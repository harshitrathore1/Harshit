...
import profileImg from '../../assets/profileharshit.png'
        ...
        <section id='about' className='py-4 px-[7vw] lg:px-[20vw] font-sans mt-16 md:mt-24 lg:mt-32'>
            <div className='flex flex-col-reverse md:flex-row justify-between'>
                ...
                <div className='md:w-1/2 text-center md:text-left mt-8 md:mt-0'>
                    ...
                    {/* Resume button */}
                    <a href="https://drive.google.com/file/d/1Dm4ygLTsBhiq5CtgfV8IrO7wK9_Tg43G/view?usp=sharing" target="_blank"
                ...
                <div className="md:w-1/2 flex justify-center md:justify-end">
                    <Tilt
                        className="w-48 h-48 sm:w-64 sm:h-64 md:w-[30vw] md:h-[30vw] border-4 border-purple-700 rounded-full"
                        tiltMaxAngleX={20}
                        tiltMaxAngleY={20}
                        perspective={1000}
                        scale={1.05}
